...
export function Offer() {
    const { t } = useLanguage();
    return (
        <section className="py-12 md:py-32 px-6 bg-[#0a0a0a] relative">
            <div className="container mx-auto max-w-6xl">
                <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
                    ...
                    >
                        <h2 className="text-3xl md:text-6xl font-light text-white mb-8">
                            {t.offer.title_prefix} <span className="font-script text-5xl md:text-7xl text-[var(--color-gold)] block mt-2">{t.offer.title_suffix}</span>
                        </h2>
